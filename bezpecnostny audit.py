...
def filterf():
    ...
    can.create_text(sirka//4, vyska//10+15, text='ČÍSLO KARTY:', font='SourceSansPro 20',anchor='e')
    entry1=tk.Entry(font="Helvetica 15 ", width=15).place(relx=.25,rely=.1, width=250)
    can.create_text(sirka//4, vyska//10+45, text='ČÍSLO ÚČTU:', font='SourceSansPro 20',anchor='e')
    entry2=tk.Entry(font="Helvetica 15 ", width=15).place(relx=.25,rely=.15, width=250)
    can.create_text(sirka//2+sirka//11, vyska//10+15, text='SUMA OD', font='SourceSansPro 20',anchor='e')
    entry3=tk.Entry(font="Helvetica 15 ", width=10).place(relx=.60,rely=.1)
    can.create_text(sirka//2+sirka//3, vyska//10+15, text='SUMA DO', font='SourceSansPro 20',anchor='e')
    entry4=tk.Entry(font="Helvetica 15 ", width=10).place(relx=.85,rely=.1)
    can.create_text(sirka//2+sirka//11, vyska//10+45, text='DÁTUM OD', font='SourceSansPro 20',anchor='e')
    entry3=tk.Entry(font="Helvetica 15 ", width=10).place(relx=.60,rely=.15)
    import calendar
    canvas=calendar.TextCalendar(calendar.MONDAY)
    str=canvas.formatmonth(2019, 12)
    print(str)
    can.create_text(sirka//2+sirka//3, vyska//10+45, text='DÁTUM DO', font='SourceSansPro 20',anchor='e')
    entry4=tk.Entry(font="Helvetica 15 ", width=10).place(relx=.85,rely=.15)
